...
public static class SeedDataExtensions
{
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        var sqlConnectionFactor = scope.ServiceProvider.GetRequiredService<ISqlConnectionFactory>();
        using var connection = sqlConnectionFactor.CreateConnection();
        ...
        const string sql = """ 
            ...
            VALUES (@Id, @Name, @Description, @Country, @State, @ZipCode, @City, @Street, @PriceAmount, @PriceCurrency,
                @CleaningFeeAmount, @CleaningFeeCurrency, @Amenities, @LastBookedOnUtc);
            """;
