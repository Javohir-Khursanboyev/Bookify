...
public class PricingService
{
    public PricingDetail CalculatePrice(Apartment apartment, DateRange period)
    {
       var currency = apartment.Price.Currency;
        ...
        var amentiesUpCharge = Money.Zero(currency);
        if(percentageUpCharge > 0)
        {
            amentiesUpCharge = new Money(
        ...
        return new PricingDetail(priceForPeriod, apartment.CleaningFee, amentiesUpCharge, totalPrice);
    }
}